...
function taxonomyUriForPrefix(prefix: string): string {
  ...
  return (
    TAXONOMY_NS[key] ??
    `https://disclosure-dag-demo.local/xbrl/demo/${encodeURIComponent(prefix)}`
  );
}
...
${factsSection}
  ...
  <footer style="font-family:system-ui,sans-serif;padding:1rem;border-top:1px solid #ccc;font-size:0.75rem;color:#666">
    Generated by disclosure-dag-demo. This file uses Inline XBRL (iXBRL) 1.1-style markup for local testing;
